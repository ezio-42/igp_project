...
public class Slider : MonoBehaviour {
    ...
    private void Update() {
        if (Input.GetMouseButtonDown(0)) _center = Input.mousePosition.x - _savedTouchPosition * GetScreenPoint();
        ...
        if (Input.GetMouseButton(0)) _savedTouchPosition = _horizontalPosition;
    }
